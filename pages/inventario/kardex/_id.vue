              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-12 col-lg-5 mx-auto">
                    ...
                    <span class="badge " :class="[model.stock <= model.stock_minimo ? 'badge-danger' : 'badge-success']"><i
                          ...
                          <tr v-for="m in model.inventarios">
                            ...
                            <td>
                              <h6><span class="badge text-xxs"
                                  :class="[m.tipo == 2 ? 'badge-danger' : 'badge-success']">{{ m.cantidad }}
                                  {{ model.medida.codigo }}</span></h6>
                            </td>
                            ...
                            <td class="align-middle text-center text-xxs">
                              <a href="javascript:void(0);" @click="DeleteItem(m.id)" data-bs-toggle="tooltip"
